...
<div class="menu" id="sticky">
        <ul class="menu-ul">
            ...
            <a href="customer/Login.php" ><li class="a-menu"><i class="fa-solid fa-right-to-bracket"></i> Login</li></a>
            <a href="customer/Profile.php" ><li class="a-menu"><i class="fa-solid fa-circle-user"></i> Profile</li></a>
            ...
            <a href="customer/cart.php"><li class="icon-cart"><i class="fa-solid fa-cart-shopping"></i><span><?php echo $row_count; ?></span></li></a>
            <!-- <li class="icon-cart"><i class="fa-solid fa-cart-shopping"></i><span>0</span></li>  -->

        </ul>
            <!----------------Create search bar----------------->
            <div class="search-box">
                <form action="customer/FoodSearch.php" method="POST">
                ...
                while($row=mysqli_fetch_assoc($res)){
                    ...
                    ?>
                        <div class="categories">     
                            <div class="image-title-c"><?php echo $row["title"]; ?></div>
                            <?php
                                if($image_name==""){
                                    ...
                                    ?>
                                    <img src="<?php echo $row["image_name"]; ?>" class="item-image-c">
                                    <?php
                                }
                            ?>

                            <div class="content2">
                                <a href="customer/ShopbyCategories.php#fruits" class="btn">Shop Now</a>
                            </div>
                        </div>
            ...
            <div class="column">
                <div class="footer-widget categories-widget">
                    ...
                    <ul>
                        ...
                        <li><a href="customer/Login.php"><i class="fa-solid fa-right-to-bracket"></i> Login</a></li>                       
                    </ul>
                </div>
            </div>
