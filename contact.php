<?php $pageTitle = 'Contact SuperLand'; ?>
<?php
...
<body>
    <main class="simple-page">
        <h1>Contact</h1>
        <p>This is a demo academic project. Replace these contact details with real project or organization details when customizing the system.</p>
        <ul>
            <li>Email: info@superland-demo.com</li>
            <li>Phone: +94 00 000 0000</li>
