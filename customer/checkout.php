   ...
   <div class="display-order">
      ...
      <div class="flex">
         ...
         <div class="inputBox">
            ...
            <input type="text" placeholder="e.g. lane no." name="lane" required>
         </div>
         <div class="inputBox">
         ...
         <div class="inputBox">
            <span>state</span>
            <input type="text" placeholder="e.g. dehiwala" name="state" required>
         </div>
         <div class="inputBox">
            <span>country</span>
            <input type="text" placeholder="e.g. srilanka" name="country" required>
         </div>
         <div class="inputBox">
            <span>pin code</span>
